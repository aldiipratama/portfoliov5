...
export const HoverEffect = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-3 md:grid-cols-5 gap-4 lg:grid-cols-7 py-10 justify-evenly",
        className
      )}
    >
      {items.map((item, idx) => (
        <div
          key={idx}
          className="relative group block py-5 h-full w-full"
  ...
  return (
    ...
    >
      <div
        ...
        className="absolute left-1/2 top-1/2 ml-[0.09375rem] h-full w-full mt-4 -translate-x-1/2 -translate-y-1/2"
      >
        <div
          style={{
            transform: transform,
  ...
  return (
    <motion.div className="pointer-events-none w-16 h-20 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-5 flex-none  inset-0">
        ...
        <>
          <motion.div className="absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-cyan-500 translate-y-[14px] w-px h-5 group-hover/pin:h-7 blur-[2px]" />
          <motion.div className="absolute right-1/2 bottom-1/2 bg-gradient-to-b from-transparent to-cyan-500 translate-y-[14px] w-px h-5 group-hover/pin:h-7  " />
