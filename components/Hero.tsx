      ...
      <div className="flex justify-between max-sm:flex-col items-center px-2">
        ...
        >
          <h1 className="dark:font-bold text-lg">
            Aldiipratama is a{" "}
            <span className="dark:text-indigo-500 text-green-500 font-bold">
              <Typed1 />
            </span>
          </h1>
          <div className="space-y-5">
            <p className="max-w-sm max-sm:text-sm text-base">
              I build responsive websites where technology meets creativity
            </p>
            <Link
            ...
            >
              <Button
                variant={"outline"}
                className="border-2 dark:border-indigo-500 border-green-500 dark:text-indigo-500 text-green-500 rounded-none"
              >
                Contact Me !!
              </Button>
            </Link>
        ...
        >
          <div className="relative w-[200px] h-[250px] mx-auto">
            <Image
              ...
              height={80}
              alt="dot-blue"
              className="absolute top-16 left-6 -z-[1]"
            />
            <Image
              src="/1.png"
              alt="pict-1"
          ...
          <div className="border-2 dark:border-white border-black max-w-[210px] p-2 flex gap-2 items-center mx-auto">
            ...
            <p className="text-base max-sm:text-sm">
              Currently Working on <span className="font-bold">Portofolio</span>
            </p>
          </div>
        </MotionDiv>
      </div>
      <div className="flex justify-center">
        ...
        >
          <fieldset className="border-2 dark:border-white border-black p-4 max-w-sm">
            ...
            <p className="text-base max-sm:text-sm">
              If you don’t take risks in this life, you can’t create a future.
            </p>
          </fieldset>
